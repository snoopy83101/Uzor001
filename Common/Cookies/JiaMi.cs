...
namespace Common
{
    ...
    public class JiaMi
    {
        const string bkey = "wangli83";
        const string KEY_64 = "zyhis*!is!~no.1OhYeah";

        const string IV_64 = "zyhis*!is!~no.1OhYeah";
        #region EnCode 加密
        /// <summary>   
        /// EnCode 加密   
        /// </summary>   
        ...
        public static string EnCode(string data)
        {
            ...
            return GetEncrypt(data, "zyhis*!is!~no.1OhYeah");
        }
        ...
        public static string DeCode(string data)
        {
            ...
            return Decrypt(data, "zyhis*!is!~no.1OhYeah");
        }
        ...
        public void RaiseCallbackEvent(string eventArgument)
        {
            ...
            if (beinettype == "1")
            {
                m_callback = uncMe(beinetstr);
            }
            else
            {
                m_callback = encMe(beinetstr);
            }
        }

        #endregion

        #region 与JS公用加密解密及相关方法
        ...
        /// <returns></returns>
        public static string encMe(string beinetstr)
        {
            if (string.IsNullOrEmpty(bkey))
                return string.Empty;

            return stringToHex(des(bkey, beinetstr, true, false, string.Empty));
        }
        ...
        /// <param name="beinetkey">密钥</param>
        /// <returns></returns>
        public static string uncMe(string beinetstr)
        {
            if (string.IsNullOrEmpty(bkey))
                return null;
            string ret = des(bkey, HexTostring(beinetstr), false, false, string.Empty);
            return ret;
        }
