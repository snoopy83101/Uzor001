...
namespace Common
{
    public class BarCodeHelper
    {
        ...
        /// 二维码生成
        /// </summary>
        /// <param name="nr">文件名称</param>
        /// <param name="url">后缀名,后面需要加上/,类似"UpImg/DingDan/"</param>
        public static void create_two(string nr, string url)
        {
            ...
            if (Common.FileString.IsFileCunZai(url))
            {
            ...
            else
            {
                ...
                bt.Save(HttpContext.Current.Server.MapPath(url));
            }
