...
namespace Common
{
    public static class JsonHelper
    {
        ...
        public static string GetJsonVal(string jsonStr, string key)
        {
        ...
        public static string ToJson(List<DataRow> list)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    string strKey = dt.Columns[j].ColumnName;
                    string strValue = list[i][j].ToString();
                    Type type = dt.Columns[j].DataType;
                    jsonString.Append("\"" + strKey + "\":");
                    strValue = StringFormat(strValue, type);
                    if (j < dt.Columns.Count - 1)
        ...
        /// <summary> 
        /// DataSet转换为Json 取得第一行,转为单个json对象
        /// </summary> 
        /// <param name="table">DataSet对象</param> 
        /// <returns>Json字符串</returns> 
        public static string ToJsonNo1(DataSet ds)
        {
        ...
        /// <summary> 
        /// Datatable转换为Json 取得第一行,转为单个json对象
        /// </summary> 
        /// <param name="table">Datatable对象</param> 
        /// <returns>Json字符串</returns> 
        public static string ToJsonNo1(DataTable dt)
        {
            StringBuilder jsonString = new StringBuilder();
