...
namespace Common
{
    ...
    public class YZMHelper
    {
        ...
        private Font[] fonts = 
    {
       new Font(new FontFamily("Times New Roman"),20 +Next(1),System.Drawing.FontStyle.Bold,GraphicsUnit.Pixel),
       new Font(new FontFamily("黑体"), 20 + Next(1),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Arial"), 20 + Next(1),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("宋体"), 20 + Next(1),System.Drawing.FontStyle.Regular)
    };
        #endregion
