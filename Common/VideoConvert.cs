...
namespace Common
{
    public class VideoConvert
    {
        ...
        #region 配置
        public static string ffmpegtool = HttpContext.Current.Server.MapPath("~/Comm/ffmpeg.exe");
        public static string mencodertool = "";
        public static string savefile = "/upload";
        ...
        /// <returns></returns>
        public string GetSmallImage(string sourceFile)
        {
            ...
            try
            {
                ...
                string Argu = @"-i " + HttpContext.Current.Server.MapPath(sourceFile) + " -y -f image2 -ss 08.010 -t 0.001 -s 352x240 " + HttpContext.Current.Server.MapPath(TargetFile);
                System.Diagnostics.ProcessStartInfo startInfo = new System.Diagnostics.ProcessStartInfo(ffmpegtool, Argu);
        ...
        {
            string ffmpeg = HttpContext.Current.Server.MapPath(VideoConvert.ffmpegtool);
        ...
        {
            string tool = HttpContext.Current.Server.MapPath(VideoConvert.mencodertool);
