...
namespace DAL
{
    //PeiSongTypeVsProduct
    public partial class PeiSongTypeVsProductDAL
    {
        ...
        public bool DeleteList(string strWhere)
        {
            ...
            int reCount = 0;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CORE.dbo.PeiSongTypeVsProduct ");
            strSql.Append(" where " + strWhere);
            try
            {//异常处理
        ...
        public DataSet GetPageList(string strWhere, string Order, int currentpage, int pagesize, string col)
        {
            ...
            object[] fenyeParmValue = new object[] { "CORE.dbo.PeiSongTypeVsProduct  WITH(NOLOCK)", col, Order, strWhere, pagesize, currentpage, 0 };
        ...
        public DataSet GetPageList(string strWhere, int currentpage, int pagesize, string cols)
        {
            ...
            strSql.Append(" FROM CORE.dbo.PeiSongTypeVsProduct  WITH(NOLOCK)  ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
