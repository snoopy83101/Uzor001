...
namespace DAL
{
    public partial class MongoDB
    {
        ...
        {
            MongoClient client = new MongoClient(System.Configuration.ConfigurationSettings.AppSettings["MongoConnectStr"].ToString());
        ...
        public static JArray Find(BsonDocument b, string collectionName, string dbName = null)
        {
            ...
            MongoClient client = new MongoClient(System.Configuration.ConfigurationManager.AppSettings["MongoConnectStr"]);
