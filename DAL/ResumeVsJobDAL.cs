...
{
    //ResumeVsJob
    public partial class ResumeVsJobDAL
    {
        ...
        public bool DeleteList(string strWhere)
        {
            ...
            int reCount = 0;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ResumeVsJob ");
        ...
        public DataSet GetPageList(string strWhere, int currentpage, int pagesize)
        {
            ...
            strSql.Append(" FROM dbo.SubResumeView  WITH(NOLOCK)  ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" * ");
            strSql.Append(" FROM dbo.SubResumeView ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
