...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        , imageUrl: "/AjaxServer/ImgUp.ashx"             //图片上传提交地址
        , imagePath: ""                  //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        // ,imageFieldName:"ProFlie"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        , compressSide: 1                           //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        , maxImageSideLength: 791                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        //附件上传配置区
        , fileUrl: "/AjaxServer/fileUp.ashx"               //附件上传提交地址
        ...
        //图片在线管理配置区
        , imageManagerUrl: URL + "net/imgManager.ashx"       //图片在线管理的处理地址
        ...
        , toolbars: [
            [
                ...
                //'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
                 'insertimage', 'emotion', 'attachment','|', 'justifyleft', 'justifycenter', 'justifyright', '|',
                //'horizontal', 'snapscreen', 'wordimage','scrawl', 'insertvideo', 'music',  'map','insertframe', 'pagebreak', 'template', 'background','|',
