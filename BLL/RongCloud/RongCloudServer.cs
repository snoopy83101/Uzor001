...
namespace io.rong
{
    public class RongCloudServer
    {
        ...
        /// <returns></returns>
        public static String PublishMessage(String appkey, String appSecret, String fromUserId, String toUserId, String objectName, String content, String pushContent)
        {
            Util.SetCertificatePolicy();
             String postStr = "content=" + content + "&" + "fromUserId=" + fromUserId + "&" + "toUserId=" + toUserId + "&" + "objectName=" + objectName+ "&pushContent=" + pushContent;
            RongHttpClient client = new RongHttpClient(appkey, appSecret, InterfaceUrl.SendMsgUrl, postStr);

            return client.ExecutePost();
        }
        public static String PublishGroupMessage(String appkey, String appSecret, String fromUserId, String toGroupId, String objectName, String content, String pushContent)
        {
            Util.SetCertificatePolicy();
            String postStr = "content=" + content + "&" + "fromUserId=" + fromUserId + "&" + "toGroupId=" + toGroupId + "&" + "objectName=" + objectName + "&pushContent=" + pushContent;
            RongHttpClient client = new RongHttpClient(appkey, appSecret, InterfaceUrl.SendGroupMsgUrl, postStr);
